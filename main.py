...
flags.DEFINE_integer("epochs", 51, "Number of epochs to train.")
...
flags.DEFINE_string("optim", "adam", "The optimization algorithm used [adam, adagrad]")
...
flags.DEFINE_string("expt", "test", "Experiment name, for naming logs, samples, and checkpoint dirs.")
flags.DEFINE_string("email", None, "Email to send results.")
